...
public class ScheduleAddActivity extends Activity {
	...
	/*
	 * private RadioButton radioWork; private RadioButton radioStudy; private
	 * RadioButton radioLife; private RadioButton radioOthers;
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		saveText.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int state = 0;
				MainActivity.dataBase.Events_Add(type, rate, mYear, mMonth,
						mDay, mHour, mMinute, title, description, reminder,
						recurrence, state);
				...
				Intent intent = new Intent(ScheduleAddActivity.this,
						AlarmReceiver.class);
				intent.putExtra("alarm_message", title);
				// In reality, you would want to have a static variable for the
				// request code instead of 192837
				PendingIntent sender = PendingIntent.getBroadcast(
						ScheduleAddActivity.this, 192837, intent,
